...
OLLAMA_NUM_PREDICT = 40         # limits response length
...
def generate_agent_reply(agent_name, my_symbols, conversation_history, num_agents, current_round, can_answer):
    """
            ...
            while True:
                ...
                if msg_type == "nickname_request":
                    ...
                    if decision.get("action") == "answer":
                        ...
                        send_json(sock, {"type": "chat", "text": text, "raw": decision.get("raw", "")})
